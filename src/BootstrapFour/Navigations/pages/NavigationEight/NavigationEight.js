  ...
  return (
    <div className="container-fluid navigation-eight">
      <div className="d-none d-lg-block d-xl-block">
        <NavigationDesktop data={data} title={title} signature={signature} />
      </div>

      <div className="d-none d-md-block d-lg-none d-xl-none">
        <NavigationTablet data={data} title={title} signature={signature} />
      </div>

      <div className="d-block d-sm-block d-md-none d-lg-none d-xl-none">
        <NavigationMobile data={data} title={title} signature={signature} />
      </div>
